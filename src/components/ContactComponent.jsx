  ...
  const PersonBlock = ({ name, surname, employee, phone, email, tg }) => {
    return (
      <div className="contact-person">
        ...
        <p className="contact-person contact-person-phone mb-1">
          Номер: <span>{phone}</span>
        </p>
        <p className="contact-person contact-person-email mb-1">
          Почта: <u>{email}</u>
        </p>
        <p className="contact-person contact-person-network mb-0">
          Телеграм: <a href="#">{tg}</a>
        </p>
      </div>
    );
  };
        ...
        <div className="row">
          ...
          <div className="contact-location col-sm-12 col-md-8 col-lg-5 mb-4">
            <div className="row">
              <div className="col-6">
                <label>Адрес:</label>
                <p className="contact-location-adress">
                  г. Самара, ул. Пушкина, д.223
                </p>
              </div>
              <div className="col-6">
                <label>Часы работы:</label>
                <p className="contact-location-timejob">
                  Пн-Пт: 9:00 – 18:00
                  <br />
                  Сб-Вс: Выходной
                </p>
